...
import { Link as ChakraLink, FormControl, FormLabel, FormErrorMessage, Input, Button, NumberInput, NumberInputField, Flex, Box, HStack,
...
export default function Properties() {
    ...
    if (AuthenticationService.loggedInUserRole() == "owner") {
        return (
            <Flex p="3" width="full" justifyContent="center">
                    <form onSubmit={newPropertyClicked}>
                        <Box h="70px" />
                        <Heading size='md' alignSelf="center">Add a new property</Heading>
